...
class FirstComeCouponEventSpec {
    ...
    fun `쿠폰을 발급이력을 기록합니다`() {
        ...
        val sut: FirstComeCouponEvent = setUpFirstComeCouponEvent(createDates = 3, excludedCouponDates = listOf(3))
    ...
    @Test
    fun `7일 연속 선착순 유저의 쿠폰 발급 이력을 기록합니다`() {
        //given
        val date = LocalDate.now()
    ...
    @Test
    fun `8일 연속 선착순 유저의 쿠폰 발급 이력을 기록합니다`() {
        //given
        val date = LocalDate.now()
    ...
    @Test
    fun `3일 연속 선착순 이후 2일뒤 선착순 유저의 쿠폰 발급 이력을 기록합니다`() {
        //given
        val date = LocalDate.now()
    ...
    @Test
    fun `6일 연속 선착순 이후 2일뒤 선착순 유저의 쿠폰 발급 이력을 기록합니다`() {
        //given
        val date = LocalDate.now()
